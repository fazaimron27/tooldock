const Ziggy = {
  ...
  routes: {
    ...
    'core.modules.index': { uri: 'modules', methods: ['GET', 'HEAD'] },
    'core.modules.install': { uri: 'modules\/install', methods: ['POST'] },
    'core.modules.uninstall': { uri: 'modules\/uninstall', methods: ['POST'] },
    'core.modules.toggle': { uri: 'modules\/toggle', methods: ['POST'] },

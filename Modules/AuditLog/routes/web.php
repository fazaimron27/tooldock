...
use Modules\AuditLog\Http\Controllers\AuditLogDashboardController;
...
Route::middleware(['web', 'auth', 'verified'])->group(function () {
    ...
    Route::get('auditlog/dashboard', [AuditLogDashboardController::class, 'index'])->name('auditlog.dashboard');
});

      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Tabs value={selectedType || 'all'} onValueChange={handleTypeChange} className="w-auto">
              <TabsList>
          ...
          {hasActiveFilters && (
            <Card className="w-fit">
              <CardHeader className="pb-3">
                <div className="flex items-center gap-2 text-sm font-semibold">Active Filters</div>
              </CardHeader>
              <CardContent>

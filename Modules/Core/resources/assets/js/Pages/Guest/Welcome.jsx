    ...
    <PageShell title="Welcome">
      <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  contact your administrator to assign you to a group with appropriate permissions.
                </p>
              </div>
            </div>
          </CardContent>
              ...
              <div className="flex items-start gap-3 p-4 rounded-lg border">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Reach out to your system administrator to request access. They can assign you to
                    a group with the appropriate permissions for your role.
                  </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              If you believe you should have access or have any questions about your account, please
              contact your system administrator. They can help you get set up with the appropriate
              permissions.
            </p>
          </CardContent>
        </Card>

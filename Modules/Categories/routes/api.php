...
/**
 * Categories Module API Routes
 *
 * API route definitions for the Categories module.
...
use Modules\Categories\Providers\RouteServiceProvider;
...
|--------------------------------------------------------------------------
|
| API routes for Categories module (if needed in the future).

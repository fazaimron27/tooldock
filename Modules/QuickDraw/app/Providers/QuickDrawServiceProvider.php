...
/**
 * QuickDraw Service Provider.
 *
 * Main service provider for the QuickDraw module. Registers commands,
...
/**
 * Class QuickDrawServiceProvider
 *
 * Bootstraps the QuickDraw module services, registrations, and configurations.
 */
class QuickDrawServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'QuickDraw';

    protected string $nameLower = 'quickdraw';

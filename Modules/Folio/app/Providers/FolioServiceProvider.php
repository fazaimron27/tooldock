 ...
 *
 * Main service provider for the Folio module. Registers commands,
...
/**
 * Class FolioServiceProvider
 *
 * Bootstraps the Folio module services, registrations, and configurations.
 */
class FolioServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Folio';

    protected string $nameLower = 'folio';
